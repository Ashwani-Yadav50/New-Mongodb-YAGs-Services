...
exports.default = pricingPlanMasterModel();
  ...
  return {
    createNew: (() => {
      var _ref = _asyncToGenerator(function* (plan) {
        ...
        const pricingModel = _mongoose2.default.model('pricingModelMaster', PricingPlanSchema, 'pricingmodels');
    ...
    getAll: (() => {
      var _ref2 = _asyncToGenerator(function* () {
        const pricingModel = _mongoose2.default.model('pricingModelMaster', PricingPlanSchema, 'pricingmodels');
        return yield _datastore2.default.findAllMaster(pricingModel);
      });
